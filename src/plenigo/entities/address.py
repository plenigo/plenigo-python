...
class Address(APIDeletableResource):
    ...
    def get(http_client: HTTPClient, entity_id: any) -> any:
        ...
        """
        data = http_client.get("%s/%s" % (Address._get_entity_url_part(), entity_id))
        return Address._create_instance(http_client, data)
    ...
    def create(http_client: HTTPClient, data: dict) -> any:
        ...
        """
        data = http_client.post(Address._get_entity_url_part(), data=data)
        return Address._create_instance(http_client, data)
